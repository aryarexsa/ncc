...
<head>
    <meta charset="utf-8">
    <title>Forgot Password - Digiexpert</title>
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <form action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="d-flex mb-2">
                                Please enter the registered email to reset the password.
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Give me a code</button>
                        </form>
                    </div>
                </div>
            </div>
