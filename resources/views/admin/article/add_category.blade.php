                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="row bg-secondary rounded mx-0 align-items-start form-container">
                            <div class="col-12 text-center py-4">
                                <h2 class="text-white">Add Category Article</h2>
                            </div>
                            <div class="col-12 px-5">
                                <form action="{{ route('admin.add.new.category.article') }}" method="POST">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="nama" class="form-label text-white">Nama Kategori
                                            Arcile</label>
                                        ...
                                        <tbody>
                                            @foreach ($data_category as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.edit.category.article', $data->id) }}"
                                                            class="btn btn-success btn-sm">Edit</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.delete.category.article', $data->id) }}"
