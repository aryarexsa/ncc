                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="row bg-secondary rounded mx-0 align-items-start form-container">
                            <div class="col-12 text-center py-4">
                                <h2 class="text-white">Edit Category Article</h2>
                            </div>
                            <div class="col-12 px-5">
                                <form action="{{ route('admin.update.category', $target->id) }}" method="POST">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="nama" class="form-label text-white">Nama Kategori</label>
                                        <input type="text" name="nama" class="form-control" id="nama"
                                            value="{{ $target->nama }}" required>
                                    </div>
                                    <div class="form-group
                                            mb-3">
                                        <label for="nama" class="form-label text-white">Nama Baru
                                            Kategori</label>
                                        <input type="text" name="nama" class="form-control" id="nama"
                                            required>
                                    </div>
