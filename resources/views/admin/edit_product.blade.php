                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="row bg-secondary rounded mx-0 align-items-start form-container">
                            ...
                            <div class="col-12 px-5">
                                <form action="{{ route('admin_update_product', $data->id) }}" method="POST"
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="deskripsi_product" class="form-label text-white">Deskripsi</label>
                                        <input type="text" name="deskripsi_product" class="form-control"
                                            id="deskripsi_product" value="{{ $data->description }}" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="gambar_product" class="form-label text-white">Gambar
                                            Sebelumnya</label>
                                        <img width="150" src="../../products/{{ $data->image }}" alt="Gambar">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="gambar_baru_product" class="form-label text-white">Ubah
                                            Gambar</label>
                                        <input type="file" name="gambar_product" class="form-control"
                                            id="gambar_baru_product" required>
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="jumlah_product" class="form-label text-white">Jumlah
                                            Product</label>
                                        <input type="text" name="jumlah_product" class="form-control"
                                            id="jumlah_product" value="{{ $data->quantity }}" required>
                                    </div>
                                    <div class="form-group mb-3 text-center">
                                        <input class="btn btn-primary" type="submit" value="Edit Products">
                                    </div>
                                </form>
                            </div>
                        </div>
