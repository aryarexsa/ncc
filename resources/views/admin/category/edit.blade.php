                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="row bg-secondary rounded mx-0 align-items-start form-container">
                            ...
                            <div class="col-12 px-5">
                                <form action="{{ route('admin_update_category', $data->id) }}" method="POST">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="nama_kategori" class="form-label text-white">Nama Kategori</label>
                                        <input type="text" name="nama_kategori" class="form-control"
                                            id="nama_kategori" value="{{ $data->nama }}" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="nama_kategori" class="form-label text-white">Nama Baru
                                            Kategori</label>
                                        <input type="text" name="nama_kategori" class="form-control"
