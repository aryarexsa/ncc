                                    ...
                                    <table class="table table-bordered border-primary table-hover bg-dark">
                                        <thead class="table-p">
                                            <tr>
                                                ...
                                                <th class="text-white border-2">Leader</th>
                                                <th class="text-white border-2">Fee</th>
                                        ...
                                        <tbody>
                                            @foreach ($projects as $project)
                                                <tr>
                                                    <th>{{ $project->nama_project }}</th>
                                                    <th>{{ $project->deskripsi_project }}</th>
                                                    <th>{{ $project->leader_project }}</th>
                                                    <th>{{ $project->fee_project }}</th>
                                                    <th><a href="{{ route('admin.edit_projects', $project->id) }}"
                                                            class="btn btn-success">Edit</a></th>
                                                    <th><a href="{{ route('admin.delete_projects', $project->id) }}"
