                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="row bg-secondary rounded mx-0 align-items-start form-container">
                            ...
                            <div class="col-12 px-5">
                                <form action="{{ route('admin.insert_projects') }}" method="POST"
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="deskripsi_project" class="form-label text-white">Deskripsi
                                            Project</label>
                                        <input type="text" name="deskripsi_project" class="form-control"
                                            id="deskripsi_project" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="leader_project" class="form-label text-white">Leader Project</label>
                                        <input type="text" name="leader_project" class="form-control"
                                            id="leader_project" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="fee_project" class="form-label text-white">Fee Project</label>
                                        <input type="text" name="fee_project" class="form-control" id="fee_project"
                                            required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="submit" class="btn btn-danger" value="Add Projects">
                                    </div>
                                </form>
                            </div>
                        </div>
